...
const TableDisplayRecording = (props) => {
  return (
    <div style={{width:"100%",alignContent:"center"}}>
        ...
        <Grid container spacing={8} key={i} style={{borderBottom:"1px solid black",width:"90%",marginLeft:"5%"}}>
          <Grid item xs><a href="#"><p>{e.name}</p></a></Grid>
          ...
          <Grid item xs><p>{e["life-span"].begin}</p></Grid>
          <Grid item xs><p>{e["life-span"].end}</p></Grid>
        </Grid>
      )}     */}
  </div>
  );
...
export default TableDisplayRecording;